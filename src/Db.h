...
class Db {
  ...
  bool delete_project_tag_transaction(const std::string &tag_name, const std::string &project_name);
  void insert_project_tag_op(const std::string &tag_name, const std::string &project_name);
  bool insert_project_tag_transaction(const std::string &tag_name, const std::string &project_name);
