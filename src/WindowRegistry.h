...
class WindowRegistry {
  ...
  public:
    ...
    static void setPhotoSelectWindow(GtkWidget *widget, PhotoSelectWindow *photoSelectWindow) {
      photoSelectWindowMap.insert(std::pair<GtkWindow*, PhotoSelectWindow*>(GTK_WINDOW(gtk_widget_get_toplevel(widget)), photoSelectWindow));
    }
    ...
    static void setPreferencesWindow(GtkWidget *widget, PreferencesWindow *preferencesWindow) {
      preferencesWindowMap.insert(std::pair<GtkWindow*, PreferencesWindow*>(GTK_WINDOW(gtk_widget_get_toplevel(widget)), preferencesWindow));
    }
